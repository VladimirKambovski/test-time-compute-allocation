...
def main():
    ...
    from marginal_token.pools.store import compute_pool_id  # noqa: E402  (canonical fix)
    ...
    def canonical_pool_id(pid, benchmark_id):
        return compute_pool_id(policy_ref="qwen3.5-4b", backend_ref="policy_primary", benchmark_id=benchmark_id,
    ...
    for pid, (text, gold) in math_data.items():
        pool_id = canonical_pool_id(pid, "math500")
    ...
    for pid in oly_ids:
        ...
        pool_id = canonical_pool_id(pid, "olympiad-a")
